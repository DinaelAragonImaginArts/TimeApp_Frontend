...
const ModalProducto = () => {
    ...
    const handleSubmit = async e => {
        ...
        await crearProducto({ nombre, descripcion, numero });
        setNombre('');
        setDescripcion('');
        setNumero('')
    }
    ...
    const { msg } = alerta;
    return (
        <Transition.Root show={modalProducto} as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={handleModalProducto}>
