...
import useProyectos from '../../../hooks/UseView';
...
const ModalEliminarColaborador = () => {
    const { eliminarColaborador, modalEliminarColaborador, handleModalEliminarColaborador } = useAdmin();
                            ...
                            <div className="sm:flex sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    <Dialog.Title as="h3" className="text-lg leading-6 font-bold text-gray-900">
                                        <div className='text-lg text-center text-red-600'>Eliminar Colaborador</div>
                                        <div className='mt-2'>
                                            <p className='text-sm text-gray-500 text-center'>
                                                Estas apunto de eliminar un colaborador, ¿Desea continuar?
                                            </p>
                                        </div>
